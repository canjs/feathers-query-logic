# Contributing to feathers-query-logic

## Developing Locally

This section will walk you through setting up the [repository](https://github.com/canjs/feathers-query-logic) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork feathers-query-logic, you can start by going to its [fork page](https://github.com/canjs/feathers-query-logic/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/feathers-query-logic
```
